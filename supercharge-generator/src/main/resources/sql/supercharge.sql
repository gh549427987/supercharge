...
--
-- Host: 127.0.0.1    Database: supercharge
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=215 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='代码生成字段信息存储';
...
INSERT INTO `code_column_config` VALUES (191,'tool_qiniu_config','config_id','bigint',NULL,'',_binary '',NULL,'PRI',_binary '',_binary '',NULL,'ID',NULL),(192,'tool_qiniu_config','access_key','text',NULL,'',_binary '',NULL,'',_binary '',_binary '\0',NULL,'accessKey',NULL),(193,'tool_qiniu_config','bucket','varchar',NULL,'',_binary '',NULL,'',_binary '',_binary '\0',NULL,'Bucket 识别符',NULL),(194,'tool_qiniu_config','host','varchar',NULL,'',_binary '',NULL,'',_binary '',_binary '',NULL,'外链域名',NULL),(195,'tool_qiniu_config','secret_key','text',NULL,'',_binary '',NULL,'',_binary '',_binary '\0',NULL,'secretKey',NULL),(196,'tool_qiniu_config','type','varchar',NULL,'',_binary '',NULL,'',_binary '',_binary '\0',NULL,'空间类型',NULL),(197,'tool_qiniu_config','zone','varchar',NULL,'',_binary '',NULL,'',_binary '',_binary '\0',NULL,'机房',NULL),(198,'sys_user','user_id','bigint',NULL,'auto_increment',_binary '',NULL,'PRI',_binary '',_binary '\0',NULL,'ID',NULL),(199,'sys_user','dept_id','bigint',NULL,'',_binary '',NULL,'MUL',_binary '',_binary '\0',NULL,'部门名称',NULL),(200,'sys_user','username','varchar',NULL,'',_binary '',NULL,'UNI',_binary '',_binary '\0',NULL,'用户名',NULL),(201,'sys_user','nick_name','varchar',NULL,'',_binary '',NULL,'',_binary '',_binary '\0',NULL,'昵称',NULL),(202,'sys_user','gender','varchar',NULL,'',_binary '',NULL,'',_binary '',_binary '\0',NULL,'性别',NULL),(203,'sys_user','phone','varchar',NULL,'',_binary '',NULL,'',_binary '',_binary '\0',NULL,'手机号码',NULL),(204,'sys_user','email','varchar',NULL,'',_binary '',NULL,'UNI',_binary '',_binary '\0',NULL,'邮箱',NULL),(205,'sys_user','avatar_name','varchar',NULL,'',_binary '',NULL,'MUL',_binary '',_binary '\0',NULL,'头像地址',NULL),(206,'sys_user','avatar_path','varchar',NULL,'',_binary '',NULL,'',_binary '',_binary '\0',NULL,'头像真实路径',NULL),(207,'sys_user','password','varchar',NULL,'',_binary '',NULL,'',_binary '',_binary '\0',NULL,'密码',NULL),(208,'sys_user','is_admin','bit',NULL,'',_binary '',NULL,'',_binary '',_binary '\0',NULL,'是否为admin账号',NULL),(209,'sys_user','enabled','bigint',NULL,'',_binary '',NULL,'MUL',_binary '',_binary '\0',NULL,'状态：1启用、0禁用',NULL),(210,'sys_user','create_by','varchar',NULL,'',_binary '',NULL,'',_binary '',_binary '\0',NULL,'创建者',NULL),(211,'sys_user','update_by','varchar',NULL,'',_binary '',NULL,'',_binary '',_binary '\0',NULL,'更新者',NULL),(212,'sys_user','pwd_reset_time','datetime',NULL,'',_binary '',NULL,'',_binary '',_binary '\0',NULL,'修改密码的时间',NULL),(213,'sys_user','create_time','datetime',NULL,'',_binary '',NULL,'',_binary '',_binary '\0',NULL,'创建日期',NULL),(214,'sys_user','update_time','datetime',NULL,'',_binary '',NULL,'',_binary '',_binary '\0',NULL,'更新时间',NULL);
...
INSERT INTO `code_gen_config` VALUES (7,'sys_user','test1',_binary '\0','test2','test3','test5','test5\\',NULL,'test4');
...
INSERT INTO `mnt_database` VALUES ('69f0f77cafc64b608f4b1d9a398b116f','eladmin','jdbc:mysql://localhost:3306/eladmin?serverTimezone=Asia/Shanghai&characterEncoding=utf8&useSSL=false','root','123456','admin','admin','2021-06-29 11:49:27','2021-06-29 11:49:27'),('907a23fbd29348b08009999193b8bb3f','qatest','jdbc:mysql://10.250.201.173:3306/qatest?serverTimezone=Asia/Shanghai&characterEncoding=utf8&useSSL=false','root','123456','admin','admin','2021-06-29 11:53:59','2021-06-29 11:53:59');
...
CREATE TABLE `sequence` (
  ...
  `name` varchar(32) NOT NULL DEFAULT ' ' COMMENT 'ID名称',
  `value` bigint unsigned NOT NULL DEFAULT '0' COMMENT 'ID当前值ֵ',
  `max_value` bigint unsigned NOT NULL DEFAULT '0' COMMENT 'ID最大值',
  `step` int NOT NULL DEFAULT '10' COMMENT 'ID取号步长',
  `version` int NOT NULL DEFAULT '0' COMMENT '版本，乐观锁',
  `create_time` timestamp NOT NULL DEFAULT '2018-12-31 16:00:00' COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_sequence_name` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='ID序列号';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3548 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='系统日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_log` VALUES (3537,'测试数据库链接','INFO','me.zhengjie.modules.mnt.rest.DatabaseController.testConnect()','{\"userName\":\"root\",\"name\":\"eladmin\",\"jdbcUrl\":\"jdbc:mysql://ocalhost:3306/eladmin?serverTimezone=Asia/Shanghai&characterEncoding=utf8&useSSL=false\",\"pwd\":\"123456\"}','10.62.0.97',2344,'admin','内网IP','Chrome 91.0.4472.101',NULL,'2021-06-29 11:49:12'),(3538,'测试数据库链接','INFO','me.zhengjie.modules.mnt.rest.DatabaseController.testConnect()','{\"userName\":\"root\",\"name\":\"eladmin\",\"jdbcUrl\":\"jdbc:mysql://localhost:3306/eladmin?serverTimezone=Asia/Shanghai&characterEncoding=utf8&useSSL=false\",\"pwd\":\"123456\"}','10.62.0.97',13,'admin','内网IP','Chrome 91.0.4472.101',NULL,'2021-06-29 11:49:24'),(3539,'新增数据库','INFO','me.zhengjie.modules.mnt.rest.DatabaseController.create()','{\"userName\":\"root\",\"name\":\"eladmin\",\"jdbcUrl\":\"jdbc:mysql://localhost:3306/eladmin?serverTimezone=Asia/Shanghai&characterEncoding=utf8&useSSL=false\",\"id\":\"69f0f77cafc64b608f4b1d9a398b116f\",\"pwd\":\"123456\"}','10.62.0.97',109,'admin','内网IP','Chrome 91.0.4472.101',NULL,'2021-06-29 11:49:27'),(3540,'测试数据库链接','INFO','me.zhengjie.modules.mnt.rest.DatabaseController.testConnect()','{\"userName\":\"root\",\"name\":\"qatest\",\"jdbcUrl\":\"jdbc:mysql://10.250.201.173:3306/qatest?serverTimezone=Asia/Shanghai&characterEncoding=utf8&useSSL=false\",\"pwd\":\"123456\"}','10.62.0.97',585,'admin','内网IP','Chrome 91.0.4472.101',NULL,'2021-06-29 11:53:58'),(3541,'新增数据库','INFO','me.zhengjie.modules.mnt.rest.DatabaseController.create()','{\"userName\":\"root\",\"name\":\"qatest\",\"jdbcUrl\":\"jdbc:mysql://10.250.201.173:3306/qatest?serverTimezone=Asia/Shanghai&characterEncoding=utf8&useSSL=false\",\"id\":\"907a23fbd29348b08009999193b8bb3f\",\"pwd\":\"123456\"}','10.62.0.97',15,'admin','内网IP','Chrome 91.0.4472.101',NULL,'2021-06-29 11:53:59'),(3542,'测试连接服务器','INFO','me.zhengjie.modules.mnt.rest.ServerDeployController.testConnect()','{\"ip\":\"127.0.0.1\",\"password\":\"123456\",\"port\":8000,\"name\":\"11\",\"account\":\"root\"}','10.62.0.97',54,'admin','内网IP','Chrome 91.0.4472.101',NULL,'2021-06-29 11:56:42'),(3543,'测试连接服务器','INFO','me.zhengjie.modules.mnt.rest.ServerDeployController.testConnect()','{\"ip\":\"10.250.200.136\",\"password\":\"123456\",\"port\":8000,\"name\":\"11\",\"account\":\"root\"}','10.62.0.97',10,'admin','内网IP','Chrome 91.0.4472.101',NULL,'2021-06-29 11:56:57'),(3544,'测试连接服务器','INFO','me.zhengjie.modules.mnt.rest.ServerDeployController.testConnect()','{\"ip\":\"10.250.200.136\",\"password\":\"123456\",\"port\":8000,\"name\":\"11\",\"account\":\"root\"}','10.62.0.97',7,'admin','内网IP','Chrome 91.0.4472.101',NULL,'2021-06-29 11:57:06'),(3545,'测试连接服务器','INFO','me.zhengjie.modules.mnt.rest.ServerDeployController.testConnect()','{\"ip\":\"10.250.200.136\",\"password\":\"Xie549427+\",\"port\":8000,\"name\":\"11\",\"account\":\"wb.xiejiehua\"}','10.62.0.97',8,'admin','内网IP','Chrome 91.0.4472.101',NULL,'2021-06-29 11:57:17'),(3546,'测试连接服务器','INFO','me.zhengjie.modules.mnt.rest.ServerDeployController.testConnect()','{\"ip\":\"10.250.200.136\",\"password\":\"Xie549427+\",\"port\":8000,\"name\":\"11\",\"account\":\"wb.xiejiehua\"}','10.62.0.97',8,'admin','内网IP','Chrome 91.0.4472.101',NULL,'2021-06-29 11:57:25'),(3547,'测试连接服务器','INFO','me.zhengjie.modules.mnt.rest.ServerDeployController.testConnect()','{\"ip\":\"10.250.200.136\",\"password\":\"Xie549427+\",\"port\":22,\"name\":\"11\",\"account\":\"wb.xiejiehua\"}','10.62.0.97',2041,'admin','内网IP','Chrome 91.0.4472.101',NULL,'2021-06-29 11:57:28');
...
INSERT INTO `sys_user` VALUES (1,2,'admin','管理员','男','18888888888','201507802@qq.com','avatar-20210629055237104.png','C:\\eladmin\\avatar\\avatar-20210629055237104.png','$2a$10$Egp1/gvFlt7zhlXVfEFw4OfWQCGPw0ClmMcc6FjTnvXNRVf9zdMRa',_binary '',1,NULL,'admin','2020-05-03 16:38:31','2018-08-23 09:11:56','2021-06-29 17:52:37'),(2,2,'test','测试','男','19999999999','231@qq.com',NULL,NULL,'$2a$10$4XcyudOYTSz6fue6KFNMHeUQnCX5jbBQypLEnGk1PmekXt5c95JcK',_binary '\0',1,'admin','admin',NULL,'2020-05-05 11:15:49','2020-09-05 10:43:38');
...
-- Dump completed on 2021-07-11 15:35:31
